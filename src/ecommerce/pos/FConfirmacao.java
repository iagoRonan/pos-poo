...
public class FConfirmacao extends javax.swing.JFrame {
    ...
    private FormaPagamento formParaBoleto(){        
        return new Boleto(1, tfVencimento.getText(), tfCodBarras.getText(), (String)cbBanco.getSelectedItem());
    }
    ...
    private void preencheCbBanco(){        
        ...
        for (TipoBanco t : lista) {
            cbBanco.addItem(t.getDescricao());
        }
    }
    ...
    private void configurarBoleto(){
        ...
        tfVencimento.setText(df.format(data.getTime()));
    }
    ...
    public static void main(String[] args){
        System.out.println(gerarNumeroBoleto());
    }
